...
int main(void)
{
  ...
  MX_TIM7_Init();
  /* USER CODE BEGIN 2 */
  HAL_TIM_Base_Start(&htim6); // Servo moving checking
  HAL_TIM_Base_Start(&htim7); // Input pin states checking
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, Out_1_Pin|S0_Pin|S1_Pin|S2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Out_2_Pin|Out_3_Pin|Out_4_Pin|LED_R_Pin
  ...
  /*Configure GPIO pin : In_8_Pin */
  GPIO_InitStruct.Pin = In_8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(In_8_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Out_1_Pin S0_Pin S1_Pin S2_Pin */
  GPIO_InitStruct.Pin = Out_1_Pin|S0_Pin|S1_Pin|S2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : Out_2_Pin Out_3_Pin Out_4_Pin LED_R_Pin
                           LED_G_Pin LED_B_Pin */
  GPIO_InitStruct.Pin = Out_2_Pin|Out_3_Pin|Out_4_Pin|LED_R_Pin
                          |LED_G_Pin|LED_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
