...
typedef int32_t (*VL53LMZ_write_Func)(uint16_t, uint16_t, uint8_t *, uint16_t);
typedef int32_t (*VL53LMZ_read_Func)(uint16_t, uint16_t, uint8_t *, uint16_t);
...
typedef struct
{
    ...
    uint16_t address;
    VL53LMZ_write_Func Write;
    VL53LMZ_read_Func Read;
    VL53LMZ_get_tick_Func GetTick;
} VL53LMZ_Platform;
...
#define VL53LMZ_DISABLE_AMBIENT_DMAX
