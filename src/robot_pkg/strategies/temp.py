...
temp(m=Move.ResetOdom(Area.BLUE_3.x, Area.BLUE_3.y, 0),
        task_steps=init_all_servos())

# STACK 10
temp(m=Move.Spline([1500, MaterialStack.STACK10.x],
                  [1000, MaterialStack.STACK10.y+150],
                  [0, -1.57],
                  800,
                  'f'))
...
temp(m=Move.Spline([MaterialStack.STACK9.x],
                    [MaterialStack.STACK9.y+150],
                    [1.57],
                    500,
                    'r'))
...
temp(m=Move.Spline([Area.BLUE_2.x],
                    [Area.BLUE_2.y],
                    [1.57],
                    500,
                    'r'),
...
temp(m=Move.Distance(300, 300, 300),
...
temp(m=Move.Distance(-200, 1500, 1500))

temp(m=Move.RotateTo(-1.57, 15, 10))

# BLUE AREA 3

temp(m=Move.Spline([Area.BLUE_3.x+100],
                    [Area.BLUE_3.y],
                    [3.14],
                    500,
                    'f'),
