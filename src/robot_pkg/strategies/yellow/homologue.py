...
########################
## YELLOW LOWER PASSIVE FOR HOMOLOGATION ##
########################

homologue = Strategy(color=Color.YELLOW, square=Square.LOWER, mood=Mood.HOMO)
...
# homologue(m=Move.To(MaterialStack.STACK9.x,
...
# homologue(m=Move.To(Area.YELLOW_2.x,
#                 Area.YELLOW_2.y + 50,
#                 'f', 1000, 500, 10, 5))
